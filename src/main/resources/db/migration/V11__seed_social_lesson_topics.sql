-- Seed lesson_topics, lesson_questions, and hint_notes for elementary social (grade 4) curriculums from V10.
-- V12 links lesson_topics.curriculum_unit_id to the matching curriculum_units row.

-- SOCIAL_4_1_HERITAGE: 우리 지역의 문화유산
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 1, '문화유산의 의미', '개념이해', 'CONCEPT', '1단원 문화유산', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
WHERE c.code = 'SOCIAL_4_1_HERITAGE'
  AND NOT EXISTS (
    SELECT 1 FROM lesson_topics lt WHERE lt.curriculum_id = c.id AND lt.sequence = 1
  );

INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 2, '문화유산 보호', '오개념 정정', 'CONCEPT', '1단원 문화유산', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
WHERE c.code = 'SOCIAL_4_1_HERITAGE'
  AND NOT EXISTS (
    SELECT 1 FROM lesson_topics lt WHERE lt.curriculum_id = c.id AND lt.sequence = 2
  );
...
WHERE c.code = 'SOCIAL_4_1_HERITAGE' AND lt.sequence = 1
  AND NOT EXISTS (
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_1_HERITAGE' AND lt.sequence = 2
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'REACTION'
  );

-- SOCIAL_4_1_PUBLIC: 지역의 공공기관과 주민 참여
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 1, '공공기관의 의미', '개념이해', 'CONCEPT', '3단원 공공기관', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
...
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 2, '지역 문제와 주민 참여', '오개념 정정', 'CONCEPT', '3단원 공공기관', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
WHERE c.code = 'SOCIAL_4_1_PUBLIC'
  AND NOT EXISTS (
    SELECT 1 FROM lesson_topics lt WHERE lt.curriculum_id = c.id AND lt.sequence = 2
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_1_PUBLIC' AND lt.sequence = 1
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'INTRO'
  );
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_1_PUBLIC' AND lt.sequence = 2
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'REACTION'
  );

-- SOCIAL_4_2_PRODUCTION: 필요한 것의 생산과 교환
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 1, '생산과 소비의 의미', '개념이해', 'CONCEPT', '2단원 생산과 교환', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
...
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 2, '지역 간 경제적 교류', '오개념 정정', 'CONCEPT', '2단원 생산과 교환', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
WHERE c.code = 'SOCIAL_4_2_PRODUCTION'
  AND NOT EXISTS (
    SELECT 1 FROM lesson_topics lt WHERE lt.curriculum_id = c.id AND lt.sequence = 2
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_2_PRODUCTION' AND lt.sequence = 1
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'INTRO'
  );
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_2_PRODUCTION' AND lt.sequence = 2
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'REACTION'
  );

-- SOCIAL_4_2_SOCIAL_CHANGE: 사회 변화와 문화 다양성
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 1, '사회 변화', '개념이해', 'CONCEPT', '3단원 사회변화', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
...
INSERT INTO lesson_topics (curriculum_id, sequence, title, subtitle, topic_type, gnb_title, created_at, updated_at)
SELECT c.id, 2, '문화 다양성 존중', '오개념 정정', 'CONCEPT', '3단원 사회변화', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM curriculums c
WHERE c.code = 'SOCIAL_4_2_SOCIAL_CHANGE'
  AND NOT EXISTS (
    SELECT 1 FROM lesson_topics lt WHERE lt.curriculum_id = c.id AND lt.sequence = 2
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_2_SOCIAL_CHANGE' AND lt.sequence = 1
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'INTRO'
  );
...
FROM lesson_topics lt
JOIN curriculums c ON lt.curriculum_id = c.id
WHERE c.code = 'SOCIAL_4_2_SOCIAL_CHANGE' AND lt.sequence = 2
  AND NOT EXISTS (
    SELECT 1 FROM lesson_questions lq WHERE lq.lesson_topic_id = lt.id AND lq.phase = 'REACTION'
  );
