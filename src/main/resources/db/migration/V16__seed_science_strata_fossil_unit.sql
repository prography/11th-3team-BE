...
SELECT lt.id, 'INTRO', '쌤, 책을 쌓아 올린 것 같은 이 절벽은 어떻게 만들어졌어요? 줄무늬는 왜 있어요?', NULL, 'curious', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
