...
class TeachPromptBuilder(
    ...
    internal fun buildSystemPrompt(unit: CurriculumUnit): String {
        val lessonConcepts = formatLessonConcepts(unit.unitJson)
    ...
    private fun formatLessonConcepts(unitJson: String): String = buildString {
        val root = aiResponseValidator.readJsonTree(unitJson)
