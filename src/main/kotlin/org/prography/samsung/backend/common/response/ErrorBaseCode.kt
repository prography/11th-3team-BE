...
enum class ErrorBaseCode(override val httpStatus: HttpStatus, override val code: Int, override val message: String) :
    ...
    NOT_READABLE(HttpStatus.BAD_REQUEST, 400, "JSON 혹은 REQUEST BODY 필드 오류입니다."),
    PAYLOAD_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, 413, "업로드 가능 용량을 초과했습니다."),
    ...
    NOT_IMPLEMENTED(HttpStatus.NOT_IMPLEMENTED, 501, "서버 내부 오류입니다."),
}
